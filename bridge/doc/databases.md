...
The value of a raceconfig is an object with an heats object describing for each heat
which cars are on each lane.
...
| heats          | Object | contains a heat configuration object           |
